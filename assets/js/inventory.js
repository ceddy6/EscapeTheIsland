...
var inventoryItems = [
    {title:"padlock-key",path:"assets/images/locks/padlock-key.jpg"},
    {title:"stepping-stones-clue",path:"assets/images/minigames/puzzles/cave/clue.bmp"},
    {title:"waterfall-clue",path:"assets/images/minigames/puzzles/cave/clue2.bmp"}
]
...
class Inventory {
    ...
    addItem(item) {
        ...
        $('#inventory-modal').find('.modal-body')
            .append('<img class="img-fluid inventory-item" id='+item+'-inventory src='+details.path+' alt='+item+'>')
