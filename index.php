...
<head>
    ...
    <script tyle="text/javascript" src="https://cdn.jsdelivr.net/jquery.shadow-animation/1/mainfile"></script>

    <!-- Include font awesome-->
    <script src="https://kit.fontawesome.com/fbd92e6244.js" crossorigin="anonymous"></script>
    ...
    <script src="assets/js/Puzzles/Waterfall.js"></script>
    <script src="assets/js/Puzzles/Well.js"></script>
    <script src="assets/js/Puzzles/Obelisk.js"></script>
    <script src="assets/js/Puzzles/Skeleton.js"></script>
    <script src="assets/js/Puzzles/Volcano.js"></script>
...
<body>
    ...
    <div class="container-fluid" id="background-map-wrapper">
        ...
        <?php include "../php/getLeaderboard.php"; ?> 
        <div class="background-clock-wrapper container-fluid">
          ...
          <div class="background-clock-digits-wrapper container-fluid">
            <div class="background-clock-digits-wrapper-2 container-fluid"> 
            <div class="clock-digit hours-tens"><span class="digital-no">0</span></div>
            <div class="clock-digit hours-units"><span class="digital-no">0</span></div>
            <div class="clock-digit separator-1"><span class="digital-no">:</span></div>
            ...
            <div class="clock-digit separator-2"><span class="digital-no">:</span></div>
            <div class="clock-digit seconds-tens"><span class="digital-no">0</span></div>
            <div class="clock-digit seconds-units"><span class="digital-no">0</span></div>
          </div>
        </div> 
      </div>
    ...
    <div id="zoom-modal" class="modal fade zoom" role="dialog">
      <div class="modal-dialog zoom">
        <div class="modal-content zoom">
          ...
          <div class="modal-footer zoom">
            <button type="button" class="btn btn-default" id="snapshot-button" onClick="takeAPicture()">Take a Picture</button>
          </div>
        </div>
      </div>
    </div>    
      ...
      <div class="modal-dialog leaderboard">
        <div class="modal-content leaderboard">
          <div class="modal-header leaderboard">
            <h4 class="modal-title leaderboard">Leaderboard</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body leaderboard">
            <!-- The Modal body contains a table-->
            <table class="table">
                <thead>
                    <tr>
